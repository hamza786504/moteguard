        ...
        <>
           <section className="md:px-0 px-5 relative w-full bg-gradient-to-r from-red-600 to-red-900 overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto px-3 py-16">
                ...
                {/* 1st accordion */}
                <h3 className="text-red-800 text-3xl md:text-5xl leading-normal font-bold mb-10">
                ...
                <div className="accordion-group">
                    {faqs2.map((faq, index) => (
                        <div
                            key={index}
                            className={`animate__animated animate__fadeInLeft wow accordion border border-solid border-gray-300 p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${openIndex2 === index ? "bg-red-50 border-red-800" : ""
                                }`}
                            data-wow-delay={`${index * 0.2}s`}
                        >
                            <button
