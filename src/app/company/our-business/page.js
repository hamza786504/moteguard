...
function OurBusiness() {
    ...
    return (
        <>
            ...
            <section className="relative max-w-6xl pt-16 mx-auto px-4" style={{ backgroundImage: 'url(https://shtheme.com/demosd/insuren/wp-content/uploads/2022/11/abs-bg3.png)' }}>
                ...
                <div className="flex flex-wrap items-start -mx-4">
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="relative translate-x-[10px] lg:translate-x-0 max-w-[500px] mx-auto">
                            ...
                            <div className='absolute -bottom-1/2 right-0'>
                                ...
                                />
                                <div className="-scale-75 rotate-z-180 absolute rounded-full w-32 lg:w-40 h-32 lg:h-40 items-center justify-center flex flex-col -bottom-[50px] border-2 border-red-900 -left-[90px] md:-left-[140px] translate-x-1/2 bg-white p-4 shadow-lg space-y-1 lg:space-y-3">
                    ...
                    <div className="mt-36 w-full lg:w-1/2 px-4 lg:mt-0">
                        <h5 className="relative flex space-x-5 text-red-800 mb-4">
                            <FiUser size={22} />
                        ...
                        <div className="flex flex-wrap -mx-4 mb-6">
                            <div className="w-full md:w-1/2 px-4 mb-6">
                                <div className="flex items-start mb-4">
                                    <div className="mr-4 text-red-900 text-xl mt-2">
                                        <BsAwardFill size={30} />
                                    </div>
                                    <div>
                            ...
                            <div className="w-full md:w-1/2 px-4 mb-6">
                                <div className="flex items-start mb-4">
                                    <div className="mr-4 text-red-900 text-xl mt-1">
                        ...
                        <div className="flex flex-row items-center space-x-4  mt-10">
                            <Link
                                href="?page_id=119"
                                className="bg-red-800 hover:bg-red-900 text-white px-6 py-3 rounded-md font-medium mb-4 md:mb-0 md:mr-8 hover:bg-primary-dark transition-colors"
                            >
                                Read More
                            </Link>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow duration-300">
                                    <div className="text-red-800 text-6xl mb-8">{feature.icon}</div>
            ...
            <section className="overflow-x-hidden relative bg-red-800 text-white py-12">
                <div className="z-[100] absolute top-0 left-0 md:[clip-path:polygon(90%_0%,100%_60%,60%_100%,0%_100%,0_0)] md:bg-pink-500/20 h-full w-[450px]"></div>
                    ...
                    <div className="flex flex-wrap flex-col items-center md:flex-row gap-0">
                        <div className="w-full md:w-1/2 overflow-hidden transition-all duration-300">
                            <div className="p-0 py-5 md:p-8 md:pb-0">
                                ...
                                <Link href={"/insights"} className="wow animate__animated animate__fadeInLeft inline-flex !mx-auto cursor-pointer capitalize bg-red-800 p-3 mt-0 text-sm md:text-base font-bold text-white rounded-lg px-5 border-none mb-10 md:mb-0 hover:bg-red-900 hover:text-white items-center justify-center space-x-3" data-wow-delay="0.6s">
                                    <span className='text-nowrap'>Learn about our solution</span> <FiArrowRight size={18} />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-1/2 relative flex items-start flex-col space-y-5 justify-center mt-0 md:mt-10 transition-all duration-300">
                            <div className="bg-pink-100 p-5 border-l-4 w-full border-pink-400">
                            ...
                            <div className="bg-red-100 p-5 border-l-4 w-full border-red-400">
                                <h4 className="text-xl md:text-2xl">Lorem ipsum dolor</h4>
                                <p className="text-sm md:text-base text-start mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus, culpa!</p>
                            </div>
            ...
            <section className="overflow-x-hidden mt-20 flex flex-col md:flex-row items-center md:items-center bg-white">
                ...
                <div className="px-4 md:px-16 py-12 w-full md:w-1/2 text-center md:text-left">
                    ...
                    <button className="bg-red-800 hover:bg-red-900 text-white font-semibold py-3 px-6 rounded-full transition duration-300">
