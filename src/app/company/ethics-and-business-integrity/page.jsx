            ...
            <div className="section max-w-xl mx-auto px-3 py-16 space-y-4">
                ...
                <div className="my-10 flex items-center justify-center flex-col md:flex-row flex-wrap">
                    <div className="w-full md:w-1/2">
                        ...
                        <button
                            className="animate__animated animate__fadeInLeft wow px-5 py-3 md:px-5 md:py-2 font-medium rounded-3xl mt-5 text-white bg-red-800 hover:bg-red-900 transition-colors duration-200 whitespace-nowrap uppercase text-sm md:text-base" data-wow-delay="0.5s"
                        >
                            contact us
                        </button>
                    </div>
                ...
                <div className="flex flex-wrap space-x-2 flex-row">
                    <a href='#file-a-report' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">File a report</a>
                    <a href='#ethics-program-structure' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">Ethics Program Structure</a>
                    <a href='#' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">History of Ethics</a>
                    <a href='#' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">Code of Conduct</a>
                    <a href='#' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">Compliance</a>
                    <a href='#' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">Anti-Corruption</a>
                    <a href='#' className="p-1 px-3 rounded-3xl bg-transparent border-red-800 text-sm md:text-base hover:bg-red-900 hover:border-red-900 border mb-2 hover:text-white">Human Trafficking</a>
                </div>


                <div id="file-a-report" className='flex flex-col items-start md:items-center'>
                    <h3 className="text-start md:text-center font-bold text-3xl md:text-4xl my-5 text-red-800 md:my-3">
                    ...
                    <Link href={"/"} className="text-start md:text-center md:mx-auto inline-flex my-5 items-center justify-center md:p-3 p-2 px-4 md:px-6 rounded-3xl bg-red-800 border-red-800 text-sm md:text-base hover:bg-red-900 space-x-2 hover:border-red-900 border mb-2 text-white"><span>File a Report</span> <BsArrowRight className='text-white' size={20} /></Link>
                </div>
            </div>
            ...
            <section className="max-w-4xl mx-auto px-2">
                <div id="ethics-program-structure">
                    <div className="flex items-center justify-center md:space-x-4 space-x-3">
                        <button className={`p-1 px-1 md:px-3 rounded-3xl bg-transparent text-base md:text-lg mb-2   font-bold hover:text-red-900 cursor-pointer ${tabSwitch === "history" && "text-red-900"}`} onClick={() => { setTabSwitch("history") }}>
                            History of Ethics
                        </button>
                        <button className={`p-1 px-1 md:px-3 rounded-3xl bg-transparent text-base md:text-lg mb-2  font-bold hover:text-red-900 cursor-pointer ${tabSwitch === "structure" && "text-red-900"}
                    ...
                    <div className="content">
                        {tabSwitch === "history" ? (
                            ...
                            <>
                                ...
                                <h4 className="text-2xl md:text-3xl text-red-800 font-semibold md:mb-10 mb-5 ">
                                    Code of Conduct
                                </h4>
                                ...
                                <button className="mb-5 flex my-5 items-center justify-center md:p-3 p-2 px-4 md:px-6 rounded-3xl bg-red-800 border-red-800 text-baes md:text-base hover:bg-red-900 space-x-2 hover:border-red-900 border text-white animate__animated animate__fadeInLeft wow" data-wow-delay="0.6s" >
                                    Access the Code of Conduct
                                </button>
                                <h4 className="mt-10 animate__animated animate__fadeInLeft wow text-2xl md:text-3xl text-red-800 font-semibold md:mb-10 mb-5" data-wow-delay="0.8s">
                                    Policies and Procedures
                                </h4>
                                <p className='text-base md:text-lg text-start mb-5 animate__animated animate__fadeInLeft wow' data-wow-delay="1s">The <strong className="text-red-800">Code of Conduct</strong> (the Code) is the basis of Leidos corporate policies and practices and is designed to promote ethical business conduct and compliance with the law. All employees are required to conduct all business affairs ethically, to comply with the Code, and certify they read and understand the Code as part of their annual required training. The Leidos core values of integrity, inclusion, innovation, agility, collaboration, and commitment are emphasized in the Code and are the foundation of our culture.</p>
                                ...
                                <h4 className="text-xl md:text-3xl text-red-800 font-bold mb-10 ">
