                                    ...
                                    <div className="flex flex-row flex-wrap">
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <select
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            >
                                            ...
                                            {errors.request_type && <p className="mt-1 text-sm text[#335f80]">{errors.request_type}</p>}
                                        </div>
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <input
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                            {errors.first_name && <p className="mt-1 text-sm text[#335f80]">{errors.first_name}</p>}
                                        </div>
                                        ...
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <input
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                            {errors.last_name && <p className="mt-1 text-sm text[#335f80]">{errors.last_name}</p>}
                                        </div>
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <input
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                            {errors.email && <p className="mt-1 text-sm text[#335f80]">{errors.email}</p>}
                                        </div>
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <input
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                            {errors.phone && <p className="mt-1 text-sm text[#335f80]">{errors.phone}</p>}
                                        </div>
                                        <div className="w-full md:w-1/2 p-1">
                                            ...
                                            <input
                                                ...
                                                className="block w-full px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                            {errors.country && <p className="mt-1 text-sm text[#335f80]">{errors.country}</p>}
                                        </div>
                                        <div className="w-full">
                                            ...
                                            {errors.contact_preference && <p className="mt-1 text-sm text[#335f80]">{errors.contact_preference}</p>}
                                        </div>
                                        <div className="w-full mt-6">
                                            ...
                                            <textarea
                                                ...
                                                onChange={handleChange}
                                                className="block w-full h-32 px-2 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-[#6c87a5] dark:focus:border-[#6c87a5] focus:ring-[#6c87a5] focus:outline-none focus:ring focus:ring-opacity-40"
                                                placeholder="Enter Additional Information"
                                            ></textarea>
                                            {errors.additional_info && <p className="mt-1 text-sm text[#335f80]">{errors.additional_info}</p>}
                                        </div>

                                        <button
                                            type="submit"
                                            className="w-full px-6 py-3 mt-6 border border-transparent text-base font-medium rounded-md text-white bg-[#6c87a5] hover:bg-[#335f80] transition-colors duration-200 whitespace-nowrap"
                                        >
                                            Submit
                                        </button>
                                    </div>
