                        ...
                        <div className="wow animate__animated animate__fadeInLeft mt-8 lg:w-1/3 lg:mx-6">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                <p className="flex items-start -mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-red-800 dark:text-red-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            ...
                            <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    <Link href="/" className="mx-1.5 dark:hover:text-red-800 text-gray-400 transition-colors duration-300 transform hover:text-red-800">
