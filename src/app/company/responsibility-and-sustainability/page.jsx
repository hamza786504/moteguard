        ...
        <>
            ...
            <section className="overflow-x-hidden flex flex-col md:flex-row items-center md:items-center from-red-200 to-red-50 bg-gradient-to-l">
                ...
                <div className="px-4 md:px-16 py-12 w-full md:w-1/2 text-center md:text-left">
                    <h2 className="text-3xl md:text-3xl font-extrabold lg:text-5xl text-red-800 leading-tight mb-6">
                        Responsibility & Sustainability
                    </h2>
            ...
            >
                <div className="max-w-6xl text-center mx-auto px-4">
                    ...
                    <div className="inline-flex !mx-auto md:p-2 rounded-xl flex-wrap gap-1 md:gap-2 justify-start md:justify-center mb-5 md:mb-10">
                        {filters.map((filter) => (
                            <button
                                ...
                                className={`text-xs sm:text-sm md:text-base p-2 ${active === filter.name ? "bg-red-800 text-white" : "text-red-800 bg-transparent"}  rounded-lg md:text-lg font-medium transition duration-300 relative group`}
                            >
                                {filter.name}
                            </button>
                        ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center animate-fadeIn">
                        ...
                        <div className="bg-red-800 p-2 md:p-4 lg:p-10 rounded-2xl w-full aspect-square md:h-[400px] flex justify-center md:justify-end">
                            <Image
            ...
            <section className='mx-auto max-w-6xl py-8 md:py-16 px-3'>
                <h3 className='text-2xl md:text-5xl text-red-800 text-center mb-8 font-extrabold md:mb-16 wow animate__animated animate__flipInX'>Additional Reporting Resources</h3>
            ...
            <section className='mx-auto max-w-6xl py-8 md:py-16 px-3'>
                <h3 className='wow animate__animated animate__flipInX text-2xl md:text-5xl text-red-800 text-center mb-8 font-extrabold md:mb-16'>
            ...
            <section className="relative my-16 py-16 md:py-32 bg-gradient-to-r from-red-800 to-red-400 overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-4">
                    ...
                    <p className='!z-10 mb-3 text-white font-normal md:text-lg text-base wow animate__animated animate__fadeInUp' data-wow-delay="0.4s">
                    ...
                    <p className='!z-10 mb-3 text-white font-normal md:text-lg text-base wow animate__animated animate__fadeInUp' data-wow-delay="0.6s">
                    ...
                    <p className='!z-10 mb-3 text-white font-normal md:text-lg text-base wow animate__animated animate__fadeInUp' data-wow-delay="0.8s">
            ...
            <section className='mx-auto max-w-6xl py-8 md:py-16 px-3'>
                <h3 className='text-2xl md:text-5xl wow animate__animated animate__flipInX text-red-800 text-center mb-8 font-extrabold md:mb-16'>
                    Additional Reporting Resources
                </h3>
