...
function Intelligence() {
 ...
 <section className="relative py-16 md:py-32 bg-gradient-to-r from-red-800 to-red-400 overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-4">
                    ...
                    <Link href={"/"} className="animate__animated animate__fadeInLeft wow rounded-3xl mt-5 bg-red-800 p-3 px-6 hover:bg-red-900 inline-flex items-center justify-center space-x-3 text-white" data-wow-delay="0.6s"><span>LEARN MORE ABOUT LAB</span> <BsArrowRight size={18} /></Link>
                </div>
            </section>
            ...
            >
             ...
             <section className="relative py-16 md:py-32 bg-gradient-to-r from-red-800 to-red-400 overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-4">
                    ...
                    <Link href={"/"} className="animate__animated animate__fadeInLeft wow rounded-3xl mt-10 bg-red-800 p-3 px-6 hover:bg-red-900 inline-flex items-center justify-center space-x-3 text-white" data-wow-delay="0.6s"><span>READ THE SERIES</span> <BsArrowRight size={18} /></Link>
                </div>
            </section>  
