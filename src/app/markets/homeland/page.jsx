    ...
    return (
        <>
            ...
            >
                ...
                <div className="p-10 max-w-4xl rounded-xl text-start mx-auto px-4 md:px-5">
                    ...
                    <div className="flex items-center justify-start space-x-1 sm:space-x-3 mt-7">
                        <button
                            className="px-3 md:px-6 py-2 border-2 border-red-900 font-medium rounded-md text-white bg-red-800 hover:bg-red-900 transition-colors duration-200 whitespace-nowrap text-sm md:text-lg animate__animated animate__fadeInUp wow flex items-center justify-center space-x-2" data-wow-delay="0.6s"
                        >
            ...
            <section className="max-w-3xl mx-auto shadow-sm shadow-gray-500 py-10 my-16">
                ...
                <span className='animate__animated animate__fadeInUp wow text-3xl md:text-5xl text-center font-extrabold block my-5 text-red-800' data-wow-delay="0.3s">1,000,000+</span>
            ...
            <section className="max-w-3xl mx-3 md:mx-auto shadow-sm bg-green-200 py-10 my-16">
                ...
                <span className='animate__animated animate__fadeInUp wow text-3xl md:text-5xl text-center font-extrabold block my-5 text-red-800' data-wow-delay="0.3s">450+</span>
                ...
                <div className="me-0 ms-auto pb-10 md:pb-0 max-w-5xl shadow-sm shadow-red-100 bg-gradient-to-r to-red-300 from-white/0">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className='flex flex-col justify-center p-20 px-10'>
                            <h4 data-wow-delay="0s" className='animate__animated animate__fadeInLeft wow text-2xl md:text-4xl text-red-800 mb-10'>Leveraging our core capabilities</h4>
                            <button type="button" data-wow-delay="0.3s" className="animate__animated animate__fadeInLeft wow bg-red-800 inline-flex justify-center items-center rounded-full hover:bg-red-900 text-white p-3 px-2 text-sm md:text-base space-x-3"><span>LEARN ABOUT OUR CORE CAPABILITIES</span> <BsArrowRight size={18} /></button>
                        </div>
