...
function Space() {
    ...
    return (
        <>
            ...
            <h3 className="text-3xl md:text-5xl mb-10 font-extrabold text-red-800 text-center">National Security Space</h3>
            ...
            <h3 className="text-3xl md:text-5xl my-10 font-extrabold text-red-800 text-center">Civil Space</h3>
