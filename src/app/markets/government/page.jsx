    ...
    return (
        <>
            ...
            <section className="overflow-x-hidden bg-gradient-to-r from-purple-100 via-pink-100 to-purple-50 py-0">
                <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="p-20 px-5 md:p-14 w-full md:w-1/2 text-center md:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-red-800 wow animate__animated animate__fadeInUp mb-7" data-wow-delay="0.2s">
                            Cybersecurity
                        </h2>
                        ...
                        <div className="mt-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                            <Link
                                href="#"
                                className="space-x-3 inline-flex items-center px-6 py-3 border-2 border-red-800 text-red-800 font-semibold rounded-full hover:bg-red-800 hover:text-white transition-colors duration-300"
                            >
            ...
            <div className="max-w-6xl my-16 mx-auto">
                ...
                <div className="min-h-screen flex items-center justify-center md:px-4 pt-0 pb-10">
                    <form
