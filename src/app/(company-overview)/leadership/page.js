                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        {teamMembers.map((member, index) => (
                            ...
                            >
                                ...
                                {/* Overlay on Hover */}
                                <div className="absolute inset-0 bg-red-900/70 bg-opacity-60 flex flex-col justify-start items-center p-6 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out translate-y-full group-hover:translate-y-6/12">
