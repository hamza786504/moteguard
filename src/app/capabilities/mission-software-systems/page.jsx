...
function MissionSoftwareSystems() {
        ...
        <>
            ...
            <section className="px-3 animate__animated animate__fadeInLeft wow py-16 mx-auto max-w-xl" data-wow-delay="0s">
                <h2 className="text-3xl md:text-5xl font-bold text-[#6c87a5] wow animate__animated animate__fadeInUp leading-tight" data-wow-delay="0.2s">
                    Developing secure software systems at scale
                </h2>
                <p className="animate__animated animate__fadeInLeft wow text-start my-4 text-base md:text-lg" data-wow-delay="0.3s">
                    We leverage scale, knowledge transfer, adaptation, and reuse to rapidly deliver high-quality, secure, and cutting-edge software to resolve our customers most pressing operational needs. We conduct extensive research and development activities to help us incorporate cutting-edge technologies and methods, such as Trusted Mission AI and Zero Trust into our commercial and government solutions. Our mission software systems have transformed operations in Defense, Healthcare, Aviation, and Intelligence. Explore a selection of our critical mission software systems below.
                </p>
...
export default MissionSoftwareSystems;
