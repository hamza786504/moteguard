    ...
    return (
        <>
            ...
            <section className="px-3 animate__animated animate__fadeInLeft wow py-16 mx-auto max-w-2xl" data-wow-delay="0s">
                ...
                <h2 className="animate__animated animate__fadeInLeft wow text-red-800 font-bold leading-tight text-4xl md:text-5xl text-start" data-wow-delay="0.4s">
                ...
                <span className="text-2xl font-bold mt-10 text-start text-red-800">
                    Our Approach
                </span>
            ...
            <section className="px-3 animate__animated animate__fadeInLeft wow py-16 mx-auto max-w-2xl" data-wow-delay="0s">
                ...
                <Link href="/" className="rounded-full mt-10 bg-red-800 p-3 px-5 hover:bg-red-900 text-white">Download the fact sheet</Link>
            </section>
