        ...
        <div className="me-0 ms-auto md:pb-0 max-w-5xl shadow-sm shadow-red-100 bg-gradient-to-r to-red-300 from-white/0">
          <div className="flex flex-wrap flex-col md:flex-row">
            <div className='w-full md:w-5/12 flex flex-col justify-center p-5 pb-0 md:p-10'>
              <h4 data-wow-delay="0s" className='animate__animated animate__fadeInLeft wow text-2xl md:text-4xl text-red-800 mb-5'>Integrating systems across our markets</h4>
              ...
              <button type="button" className=' space-x-3 px-5 inline-flex rounded-full mt-8 items-center justify-center text-white bg-red-800 hover:bg-red-900 p-5 py-3'><span>LEARN ABOUT OUR MARKETS</span> <FaArrowRight size={18} /> </button>
            </div>
