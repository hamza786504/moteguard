            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-10">
                ...
                <div className="flex w-full md:w-auto">
                    <input
                        ...
                        className="w-full md:w-64 border border-gray-300 rounded-l px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-800"
                        value={searchQuery}
                    ...
                    {Object.entries(filters[0]).map(([filterName, options], index) => (
                        <div key={index} className="mb-3 w-full sm:w-1/2 md:w-1/4 px-2">
                            <div className="flex flex-col">
                                ...
                                <select
                                    className="text-black border border-gray-300 text-base px-2 py-2 w-full rounded focus:ring-2 focus:ring-red-800 focus:outline-none"
