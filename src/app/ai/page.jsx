    ...
    return (
        <>
            ...
            <section className="px-3 animate__animated animate__fadeInLeft wow py-16 mx-auto max-w-xl" data-wow-delay="0s">
                ...
                <Link href={"/"} className='!z-10 text-white p-4 px-7 inline-block mt-10 bg-red-800 hover:bg-red-900 md:text-base text-sm wow animate__animated animate__fadeInUp font-bold rounded-full' data-wow-delay="0.4s">
                    READ THE ARTICLE
                </Link>
            </section>
            ...
            <section className="overflow-x-hidden py-0">
                <div className="flex flex-col md:flex-row items-center">
                    {/* Left Content */}
                    <div className="bg-gradient-to-b from-green-100 via-pink-100 to-blue-50 p-20 px-5 md:p-14 w-full md:w-1/2 text-center md:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-red-800 wow animate__animated animate__fadeInUp leading-tight" data-wow-delay="0.2s">
