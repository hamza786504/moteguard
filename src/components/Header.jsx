...
export default function Header() {
    ...
    return (
        <header className="relative w-full bg-white shadow-md z-50 h-22">
            ...
            <div className={`${menuOpen === false && "hidden"} z-100 fixed overflow-hidden top-22 left-0 w-full bg-red-50 border-red-800 border`} style={{ height: "calc(100vh - 88px)" }}>
                <div className="rounded-full h-[750px] w-[750px] bg-red-600 opacity-15 absolute -bottom-[400px] -right-1/5"></div>

                <div className="z-100 w-full flex items-stretch justify-stretch h-full mx-auto relative overflow-x-hidden">
                    {/* Main Menu */}
                    <div className={`w-full md:max-w-[350px] bg-red-800 transition-transform duration-300 ease-in-out ${subMenuIndex !== null && isMobile ? '-translate-x-full' : 'translate-x-0'}`}>
                        <ul className="relative overflow-x-hidden space-y-1 p-6 w-full h-full">
                            <div className="rounded-full h-[350px] w-[350px] bg-red-700 absolute bottom-0 -left-1/2"></div>
                            <div className="rounded-full h-[270px] w-[270px] bg-red-600 absolute bottom-[20px] -left-1/2"></div>
            ...
            >
                ...
                <div className="flex flex-col items-start px-6">
                    ...
                    />
                    <button className="mt-4 px-6 py-2 text-white rounded-md bg-red-800 hover:bg-red-900 transition">
                        Search
                    </button>
                </div>
            </div>
