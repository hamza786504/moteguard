...
{/* Bottom-left circle */}
                ...
                <div className="relative z-10 max-w-2xl mx-auto px-4">
                    ...
                    <div className="flex space-x-2 items-center justify-start">
                        {btns.map((btn, id) => {
                            return (
                                <Link key={id} href={btn.href} className='flex items-center justify-center !z-10 text-white p-3 px-7 space-x-3 mt-10 bg-red-800 hover:bg-red-900 md:text-base text-sm wow animate__animated animate__fadeInUp font-bold rounded-full' data-wow-delay={`${0.4 + (id + 1)}s`} >
                                    <span>{btn.text}</span>
