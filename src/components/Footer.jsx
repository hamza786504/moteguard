...
function Footer() {
  return (
    <>
      <footer className="max-w-6xl mb-3 md:mb-10 mx-2 md:mx-auto rounded-2xl pt-16 mt-16 px-10 overflow-hidden relative py-10 bg-red-900">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {menuData.map((data, idx) => {
              return (
                <div
                  key={idx}
                  className='z-50 wow animate__animated animate__fadeInUp'
